            ...
            <div class="form-container">
                <form action="/admin/team" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" placeholder="Describe their role and contributions..."></textarea>
                    </div>

                    <div class="form-group">
                        <label>Profile Picture</label>
                        <input type="file" name="avatar" accept="image/*">
                        <small style="color: #666;">Leave empty to use auto-generated avatar</small>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="checkbox-label">
                            <input type="checkbox" name="is_active" checked> Active (show on website)
                        </label>
                    </div>
